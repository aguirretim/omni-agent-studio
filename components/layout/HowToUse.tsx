              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                  ...
                  <div className="space-y-2 p-4 border border-[#27272a] bg-[#121214] rounded-lg">
                    ...
                    <p className="text-xs text-zinc-400 leading-relaxed">
                      Click <strong className="text-zinc-200">Launch Agent Team</strong> to open an interactive terminal with Claude Code ready to run. Type <code className="text-zinc-300">/build-with-agent-team [plan]</code> to start. The terminal opens in its own window — PowerShell (single window) by default, or Windows Terminal with tmux split panes if WSL and tmux are installed.
                    </p>
                  </div>
                </div>
